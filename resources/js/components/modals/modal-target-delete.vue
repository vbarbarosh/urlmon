            ...
            <div class="xm modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p><code>{{ value.target.url }}</code></p>
                    </div>
...
<script>
    import api_targets_delete from '../../helpers/api/api_targets_delete';
    ...
    const modal_target_delete = {
        ...
        methods: {
            click_delete: m_modal_hide(async function () {
                let out = false;
                try {
                    await blocking(api_targets_delete({target: this.value.target}));
                    out = true;
                }
                finally {
